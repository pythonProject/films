...
DATABASES = {
    'default': {
        ...
        'NAME': 'films',                      # Or path to database file if using sqlite3.
        'USER': 'films',                      # Not used with sqlite3.
        'PASSWORD': 'films',                  # Not used with sqlite3.
...
SECRET_KEY = 'f50crui3@(zl$2p*5g!*v313+lz-6dc&amp;)=as(3)q)%om&amp;giz2-'
